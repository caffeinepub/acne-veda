...
import {
  PatientDetailForm,
  type PatientDetails,
} from "../components/PatientDetailForm";
...
export function ScanPage() {
  ...
  const handleFile = useCallback(
    async (file: File) => {
      ...
      setIsScanning(false);
      if (actor && username) {
        actor.addAssessmentHistory(username).catch(() => {});
      }
    ...
    <main className="min-h-screen bg-background">
      <section className="max-w-5xl mx-auto px-4 py-10 sm:py-16">
        ...
        >
          ...
          {/* Connector */}
          <div className="mx-3 flex-shrink-0 w-12 h-0.5 relative overflow-hidden rounded-full bg-primary/20">
            <motion.div
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.div
              ...
              className="space-y-6"
            >
              <PatientDetailForm details={patient} onChange={setPatient} />
                      ...
                      >
                        ...
                        <div className="text-sm text-green-700 space-y-2 text-left w-full">
                          ...
                          <ul className="space-y-1.5">
                            <li>
                              🌅 Follow a consistent daily Dinacharya (daily
                              routine)
                            </li>
                            <li>🥗 Eat a Pitta-balancing, seasonal diet</li>
                            <li>
                              💧 Stay well-hydrated with warm water and herbal
                              teas
                            </li>
                            <li>
                              🦴 Use gentle, natural cleansers suited to your
                              Prakriti
                            </li>
                        ...
                        <p className="text-xs text-green-600 italic">
                          Consult Dr. Akash Hari (BAMS) for a personalised
